...
export const thresholdActionConfigs = {
  rowActions: {
    firstAction: EditThreshold,
    moreActions: [
      {
  ...
  batchActions: [DeleteThreshold],
  primaryActions: [CreateThreshold],
};

export default thresholdActionConfigs;
